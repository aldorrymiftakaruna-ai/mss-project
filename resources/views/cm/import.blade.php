...
@section('title', 'Import Data CM')
@section('page-title', 'Import Data CM')
@section('page-sub', '— Unggah file Excel pengukuran')

@section('content')
<div class="max-w-xl mx-auto mt-4">
    <div class="bg-white rounded-xl shadow p-6">
        <h2 class="text-lg font-bold mb-1">Import Data CM dari Excel</h2>
