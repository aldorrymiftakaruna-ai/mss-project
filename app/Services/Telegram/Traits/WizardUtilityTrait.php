 ...
 *   - equipmentLabel()         : Label ringkas equipment dari state
 *   - reportTypeLabel()        : Label corrective/preventive dari state
...
trait WizardUtilityTrait
{
    ...
    /**
     * Bangun label ringkas untuk equipment yang terkunci di state.
     * Dipakai di pesan konfirmasi, prompt step, dan ringkasan laporan.
     *
     * @param  array  $state State wizard
     * @return string Label equipment (tag_no + deskripsi)
     */
    ...
    /**
     * Label corrective/preventive dari state.
     *
     * @param  array  $state State wizard
     * @return string 'Corrective' atau 'Preventive'
     */
    protected function reportTypeLabel(array $state): string
    {
        return ($state['report_type'] ?? 'corrective') === 'preventive'
            ? 'Preventive'
            : 'Corrective';
    }
